...
class OffreController extends AbstractController
{
    ...
    public function index(Request $request, OffreRepository $offreRepository): Response
    {
        ...
        // Use repository method to filter by title if filter is provided
        if ($filter) {
            $offres = $offreRepository->findByTitle($filter, [$sortBy => $sortOrder]);
        } else {
            // Otherwise, retrieve all offers
            $offres = $offreRepository->findBy([], [$sortBy => $sortOrder]);
        }
